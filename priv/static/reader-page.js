...
let META = JSON.parse(document.getElementById("page-meta").textContent);
      
      let seeds = JSON.parse(document.getElementById("verse-seeds").textContent);
      let chapterDisplay = META.display;
      // slug → { api, noteEl }
